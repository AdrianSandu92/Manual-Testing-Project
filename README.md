...
All the test cases exported into a xlsx can be downloaded from this [testcases.xlsx](https://github.com/AdrianSandu92/Manual-Testing-Project/raw/main/files/testcases.xlsx)
...
* Bugs have been created based on the failed tests. Bug titles:
 ...
 The complete bug reports generated from Jira can be downloaded here: [Bugs.pdf](https://github.com/AdrianSandu92/Manual-Testing-Project/raw/main/files/Bugs.pdf)
